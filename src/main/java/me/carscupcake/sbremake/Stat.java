...
public enum Stat {
    ...
    HunterFortune("Hunter Fortune", "♣", "§d", false),
    ...
    OreFortune("Ore Fortune", "☘", "§6", false),
    BlockFortune("Block Fortune", "☘", "§6", false),
    DwarvenMetalFortune("Dwarven Metal Fortune", "☘", "§6", false),
    GemstoneFortune("Gemstone Fortune", "☘", "§6", false),
    ...
    FigFortune(true, "Fig Fortune", "☘", "§6"),
    MangroveFortune(true, "Mangrove Fortune", "☘", "§6"),
    ...
    TrophyFishChance("Trophy Fish Chance", "♔", "§6", false, 0, 150),
    ColdResistance("Cold Resistance", "❄", "§b", false),
    HeatResistance("Heat Resistance", "♨", "§c", false),
    ...
    Respiration("Respiration", "⚶", "§3", false, 30, -1),
    PressureResistance("Pressure Resistance", "❍", "§9", false),
    ...
    HuntingWisdom("Hunting Wisdom", "☯", "§3", false, 0, -1),
