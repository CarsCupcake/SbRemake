...
public class Hub extends ForagingIsle {
    ...
    protected void register() {
        ...
        npcs = new AbstractNpc[]{new MerchantNpc(new Pos(-9, 68, -125), container, "Mine Merchant", new PlayerSkin("", ""),
                ...
                new MerchantNpc(new Pos(-10, 68, -130), container, "Weaponsmith", new PlayerSkin("", ""),
                        List.of(new Pair<>(ISbItem.get(UndeadSword.class).create(), new CoinsCost(100)), new Pair<>(ISbItem.get(EndSword.class).create(), new CoinsCost(150)),
                                ...
                                new Pair<>(ISbItem.get(WitherBow.class).create(), new CoinsCost(250)), new Pair<>(ISbItem.get(ArtisanalShortbow.class).create(), new CoinsCost(600)))).withClickTag(),
        ...
        ).withInteraction((player, ignored) -> player.showBank()).withClickTag(),
