...
public enum NormalEnchantments implements SkyblockEnchantment {
    ...
    SmartyPants("Smarty Pants", "smarty_pants", 0, 5, ItemType.Leggings) {
        @Override
        public Lore getDescription() {
    ...
    public abstract Lore getDescription();

    private final Lazy<Lore> lore = new Lazy<>(this::getDescription);
