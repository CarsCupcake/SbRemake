...
public abstract class CrimsonChestplateBaseline implements ISbItem, ISbItem.StatProvider, Upgradable, GemstoneSlots, ColoredLeather {

    protected abstract KuudraArmorTier armorTier();
    @Override
    public String getId() {
        return STR."\{armorTier().getId()}CRIMSON_CHESTPLATE";
    }

    @Override
    public String getName() {
        return STR."\{armorTier().getName()} Crimson Chestplate";
    }
