...
public enum Pets implements IPet {
    ...
    Ghoul("Ghoul", PetType.Combat, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODc5MzQ1NjViZjUyMmY2ZjQ3MjZjZGZlMTI3MTM3YmUxMWQzN2MzMTBkYjM0ZDhjNzAyNTMzOTJiNWZmNWIifX19",
            ...
            new PetAbility("Undead Slayer", new Lore("§7Gain §b%b%x§7 Combat XP against §aZombies§7.", "%b%", (item, ignored) -> StringUtils.cleanDouble(1 + (0.005 * petLevel(item)), 3))),
            new PetAbility("Army of the Dead", new Lore("§7Increases the amount of souls you can store by §a2§7 and the chance of getting a mob's soul by §a%b%%§7.", "%b%", (item, ignored) -> StringUtils.cleanDouble((0.2 * petLevel(item)), 1))),
            new PetAbility("Reaper Soul",
                    new Lore("§7Reduces the summoning cost of mobs by §a%a%%§7 and increases their damage output by §a%b%%§7. Increases the health of all summoned mobs by §a%c%%§7.",
                            Map.of("%b%", (item, ignored) -> StringUtils.cleanDouble((0.2 * petLevel(item)), 1), "%a%", (item, ignored) -> StringUtils.cleanDouble((0.3 * petLevel(item)), 1), "%c%", (item, ignored) -> String.valueOf(petLevel(item))))));
