    ...
    SlayerQuest {
        ...
        public String[] apply(SkyblockPlayer player) {
            ...
            return switch (player.getSlayerQuest().getStage()) {
                case XpGathering -> new String[]{" ", "§fSlayer Quest", "§5" + (player.getSlayerQuest().getSlayer().getSlayer().getName()) ,
                ...
                case MobKilling -> new String[]{" ", "§fSlayer Quest", "§5" + (player.getSlayerQuest().getSlayer().getSlayer().getName()) , "§eSlay the boss!"};
                case Completed -> new String[]{" ", "§fSlayer Quest", "§a" + (player.getSlayerQuest().getSlayer().getSlayer().getName()) , "§eBoss Slain!"};
                case Failed -> new String[]{" ", "§fSlayer Quest", "§c" + (player.getSlayerQuest().getSlayer().getSlayer().getName()) , "§eQuest Failed!"};
            };
        }
    },
    Footer {
