...
public class LonesomeMiner extends HotmUpgrade {
    ...
    public Lore lore(int level) {
        return new Lore("§7Increases " + (Stat.Strength) + "§7, " + (Stat.CritChance) + "§7, " + (Stat.CritDamage) + "§7, " + (Stat.Defense) + "§7 and " + (Stat.Health) + " §7stats gain by §a%p%% §7while in the Crystal Hollows.", Map.of("%p%", (ignored, ignored2) -> {
