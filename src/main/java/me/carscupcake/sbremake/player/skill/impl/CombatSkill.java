...
public class CombatSkill extends ISkill {
    public static final EventNode<Event> LISTENER = EventNode.all("skill.combat").addListener(PlayerStatEvent.class, event -> {
            ...
            }).addListener(PlayerMeleeDamageEntityEvent.class, CombatSkill::process)
            .addListener(PlayerProjectileDamageEntityEvent.class, CombatSkill::process)
