...
public class DiamondOre extends MiningBlock {
    ...
    public Set<SbItemStack> getDrops(SkyblockPlayer player) {
        ...
        return Set.of(withMiningFortune(ISbItem.get((item != null && item.getEnchantmentLevel(NormalEnchantments.SilkTouch) > 0) ? Material.DIAMOND_ORE : Material.DIAMOND), 1, player));
    }
