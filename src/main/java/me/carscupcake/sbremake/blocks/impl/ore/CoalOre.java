...
public class CoalOre extends MiningBlock {
    ...
    public Set<SbItemStack> getDrops(SkyblockPlayer player) {
        ...
        return Set.of(withMiningFortune(ISbItem.get((item != null && item.getEnchantmentLevel(NormalEnchantments.SilkTouch) > 0) ? Material.COAL_ORE : Material.COAL), 1, player));
    }
